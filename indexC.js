...
const URL = "https://teachablemachine.withgoogle.com/models/9L86AYecl/";
...
async function predict(imageModel = webcam.canvas) {
    ...
    //Predict the answer
    if(classNameShow=="Fluorine"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 9 <br> Atomic Mass: 18.998403 amu <br> Group: 17 <br> Electronic Configuration: [He] 2s"+'2'.sup()+" 2p"+'5'.sup();
    }
    else if(classNameShow=="Neon"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 10 <br> Atomic Mass: 20.179 amu <br> Group: 18 <br> Electronic Configuration: [He] 2s"+'2'.sup()+" 2p"+'6'.sup();
    }
    else if(classNameShow=="Sodium"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 11 <br> Atomic Mass: 22.98977 amu <br> Group: 1 <br> Electronic Configuration: [Ne] 3s"+'1'.sup();
    }
    else if(classNameShow=="Magnesium"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 12 <br> Atomic Mass: 24.305 amu <br> Group: 2 <br> Electronic Configuration: [Ne] 3s"+'2'.sup();
    }
}
