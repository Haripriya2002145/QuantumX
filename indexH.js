...
const URL = "https://teachablemachine.withgoogle.com/models/nbiNDnta_/";
...
async function predict(imageModel = webcam.canvas) {
    ...
    //Predict the answer
    if(classNameShow=="Copper"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 29 <br> Atomic Mass: 63.546 amu <br> Group: 11 <br> Electronic Configuration: [Ar] 3d"+'10'.sup()+" 4s"+'1'.sup();
    }
    else if(classNameShow=="Zinc"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 30 <br> Atomic Mass: 65.38 amu <br> Group: 12 <br> Electronic Configuration: [Ar] 3d"+'10'.sup()+" 4s"+'2'.sup();
    }
