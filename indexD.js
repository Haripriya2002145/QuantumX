...
const URL = "https://teachablemachine.withgoogle.com/models/Mf9UikLoN/";
...
async function predict(imageModel = webcam.canvas) {
    ...
    //Predict the answer
    if(classNameShow=="Aluminium"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 13 <br> Atomic Mass: 26.98154 amu <br> Group: 13 <br> Electronic Configuration: [Ne] 3s"+'2'.sup()+" 3p"+'1'.sup();
    }
    else if(classNameShow=="Silicon"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 14 <br> Atomic Mass: 28.0855 amu <br> Group: 14 <br> Electronic Configuration: [Ne] 3s"+'2'.sup()+" 3p"+'2'.sup();
    }
    else if(classNameShow=="Phosphorus"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 15 <br> Atomic Mass: 30.97376 amu <br> Group: 15 <br> Electronic Configuration: [Ne] 3s"+'2'.sup()+" 3p"+'3'.sup();
    }
    else if(classNameShow=="Sulphur"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 16 <br> Atomic Mass: 32.06 amu <br> Group: 16 <br> Electronic Configuration: [Ne] 3s"+'2'.sup()+" 3p"+'4'.sup();
    }
}
