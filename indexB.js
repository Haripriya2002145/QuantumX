...
const URL = "https://teachablemachine.withgoogle.com/models/m8MmWSscK/";
...
async function predict(imageModel = webcam.canvas) {
    ...
    //Predict the answer
    if(classNameShow=="Boron"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 5 <br> Atomic Mass: 10.81 amu <br> Group: 13 <br> Electronic Configuration: [He] 2s"+'2'.sup()+" 2p"+'1'.sup();
    }
    else if(classNameShow=="Carbon"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 6 <br> Atomic Mass: 12.011 amu <br> Group: 14 <br> Electronic Configuration: [He] 2s"+'2'.sup()+" 2p"+'2'.sup();
    }
    else if(classNameShow=="Nitrogen"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 7 <br> Atomic Mass: 14.0067 amu <br> Group: 15 <br> Electronic Configuration: [He] 2s"+'2'.sup()+" 2p"+'3'.sup();
    }
    else if(classNameShow=="Oxygen"){
        document.getElementById("fullAnswer").innerHTML="Atomic Number: 8 <br> Atomic Mass: 15.9994 amu <br> Group: 16 <br> Electronic Configuration: [He] 2s"+'2'.sup()+" 2p"+'4'.sup();
    }
}
